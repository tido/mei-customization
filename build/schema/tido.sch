<?xml version="1.0" encoding="UTF-8"?><sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:rng="http://relaxng.org/ns/structure/1.0" queryBinding="xslt2">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-att.chord.log-require_chord_stem.dir-constraint-2">
      <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="mei:chord">
                  <sch:assert test="exists(@stem.dir)">Must have dur attribute.</sch:assert>
                </sch:rule>
   </pattern>
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-att.classcodeident-classcode-check_classcodeTarget-constraint-3">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-att.controlevent-no_layer_with_multivalue_staff-constraint-4">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-att.controlevent-no_place_with_multivalue_staff-constraint-5">
      <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="mei:*[@staff]">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-att.name-nymref-check_nymrefTarget-constraint-6">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-att.note.log-require_oct_and_pname_or_loc-constraint-7">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-att.note.log-standalone_note_require_dur-constraint-8">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-att.note.log-standalone_note_require_stem.dir-constraint-9">
      <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="mei:note[not(ancestor::mei:chord)]">
                  <sch:assert test="exists(@stem.dir)">Must have stem.dir attribute.</sch:assert>
                </sch:rule>
   </pattern>
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-att.note.log-no_note_dur_in_chord-constraint-10">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-att.note.log-no_note_stem.dir_in_chord-constraint-11">
      <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="mei:note[ancestor::mei:chord]">
                  <sch:report test="@stem.dir">@stem.dir not permitted on notes within a chord.</sch:report>
                </sch:rule>
   </pattern>
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-att.startendid-endid-check_endidTarget-constraint-12">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-att.startid-startid-check_startidTarget-constraint-13">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-att.typed-subtype-When_subtype-constraint-14">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-clef-Clef_position_lines-constraint-15">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-clef-Clef_position_nolines-constraint-16">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-dynam-dynam_start-type_attributes_required-constraint-17">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-dynam-dynam_end-type_attributes-constraint-18">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-keySig-key_att_pair-constraint-19">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-mei-Check_staff-constraint-20">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-ornam-ornam_start-type_attributes_required-constraint-21">
            <sch:rule xmlns:a="http://relaxng.org/ns/compatibility/annotations/1.0" xmlns="http://www.tei-c.org/ns/1.0" context="mei:ornam">
               <sch:assert test="@startid or @tstamp or @tstamp.ges or @tstamp.real">Must have one of
              the attributes: startid, tstamp, tstamp.ges or tstamp.real</sch:assert>
            </sch:rule>
         </pattern>
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-rest-Check_restline-constraint-22">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-section-Check_sectionexpansion-constraint-23">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-staffDef-Check_staffDefn-constraint-24">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-staffDef-Check_ancestor_staff-constraint-25">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-staffDef-Check_clef_position_staffDef-constraint-26">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-staffDef-Check_clef_position_staffDef_nolines-constraint-27">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-staffDef-Check_tab_strings_lines-constraint-28">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-staffDef-Check_tab_strings_nolines-constraint-29">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-staffGrp-Check_staffGrp_unique_staff_n_values-constraint-34">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-change-change_requirements-constraint-35">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-beam-When_not_copyof_beam_content-constraint-37">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-att.spanning.req-require_pricesely_one_start_spec-constraint-44">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" id="tido-att.spanning.req-require_pricesely_one_end_spec-constraint-45">
      <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="mei:slur">
