<?xml version="1.0" encoding="UTF-8"?><xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:saxon="http://saxon.sf.net/" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:mei="http://www.music-encoding.org/ns/mei" version="2.0"><!--Implementers: please note that overriding process-prolog or process-root is 
   ...
   <!--PATTERN tido-att.controlevent-require_staff_attribute-constraint-2-->
   ...
   <xsl:template match="mei:dynam|mei:fing|mei:fingGrp|mei:mordent|mei:ornam|mei:pedal|mei:tie|mei:trill|mei:turn|mei:fermata|mei:octave" priority="1000" mode="M3">
		...
		<!--ASSERT -->
      <xsl:choose>
         <xsl:when test="ancestor-or-self::*[name()='staff' or @staff]"/>
         <xsl:otherwise>&#x2028;The element or one of its ancestors must be a staff or contain a @staff attribute. </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M3"/>
   </xsl:template>
   ...
   <!--PATTERN tido-keySig-key_att_pair-constraint-22-->
   ...
   <!--PATTERN tido-mei-Check_staff-constraint-23-->


	  <!--RULE -->
   <xsl:template match="mei:*[@staff]" priority="1000" mode="M24">
   ...
   <!--PATTERN tido-ornam-ornam_start-type_attributes_required-constraint-24-->


	  <!--RULE -->
   <xsl:template match="mei:ornam" priority="1000" mode="M25">
   ...
   <!--PATTERN tido-rest-Check_restline-constraint-25-->


	  <!--RULE -->
   <xsl:template match="mei:rest[@line]" priority="1000" mode="M26">
   ...
   <!--PATTERN tido-section-Check_sectionexpansion-constraint-26-->


	  <!--RULE -->
   <xsl:template match="mei:section[mei:expansion]" priority="1000" mode="M27">
   ...
   <!--PATTERN tido-staffDef-Check_staffDefn-constraint-27-->


	  <!--RULE -->
   <xsl:template match="mei:staffDef" priority="1000" mode="M28">
   ...
   <!--PATTERN tido-staffDef-Check_ancestor_staff-constraint-28-->


	  <!--RULE -->
   <xsl:template match="mei:staffDef[ancestor::mei:staff]" priority="1000" mode="M29">
      <xsl:variable name="thisstaff" select="@n"/>
   ...
   <!--PATTERN tido-staffDef-Check_clef_position_staffDef-constraint-29-->


	  <!--RULE -->
   <xsl:template match="mei:staffDef[@clef.line and @lines]" priority="1000" mode="M30">
   ...
   <!--PATTERN tido-staffDef-Check_clef_position_staffDef_nolines-constraint-30-->


	  <!--RULE -->
   <xsl:template match="mei:staffDef[@clef.line and not(@lines)]" priority="1000" mode="M31">
      <xsl:variable name="thisstaff" select="@n"/>
   ...
   <!--PATTERN tido-staffDef-Check_tab_strings_lines-constraint-31-->


	  <!--RULE -->
   <xsl:template match="mei:staffDef[@tab.strings and @lines]" priority="1000" mode="M32">
   ...
   <!--PATTERN tido-staffDef-Check_tab_strings_nolines-constraint-32-->


	  <!--RULE -->
   <xsl:template match="mei:staffDef[@tab.strings and not(@lines)]" priority="1000" mode="M33">
      <xsl:variable name="countTokens" select="count(tokenize(normalize-space(@tab.strings), '\s'))"/>
      <xsl:variable name="thisStaff" select="@n"/>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="mei:staffDef[@lines.color and @lines]" priority="1001" mode="M34">
	  ...
	  <!--RULE -->
   <xsl:template match="mei:staffDef[@lines.color and not(@lines)]" priority="1000" mode="M34">
      <xsl:variable name="countTokens" select="count(tokenize(normalize-space(@lines.color), '\s'))"/>
      <xsl:variable name="thisStaff" select="@n"/>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="mei:staffDef[@ppq][ancestor::mei:scoreDef[@ppq]]" priority="1000" mode="M35">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="mei:staffDef[@ppq][preceding::mei:scoreDef[@ppq]]" priority="1000" mode="M36">
      <xsl:variable name="staffPPQ" select="@ppq"/>
   ...
   <!--PATTERN tido-staffGrp-Check_staffGrp_unique_staff_n_values-constraint-37-->


	  <!--RULE -->
   <xsl:template match="mei:staffGrp" priority="1000" mode="M37">
   ...
   <!--PATTERN tido-tempo-tempo_in_header_disallow_most_attrs-constraint-38-->


	  <!--RULE -->
   <xsl:template match="mei:tempo[ancestor::mei:meiHead]" priority="1000" mode="M38">
   ...
   <!--PATTERN tido-tempo-tempo_start-type_attributes_required-constraint-39-->


	  <!--RULE -->
   <xsl:template match="mei:tempo[not(ancestor::mei:syllable) and not(ancestor::mei:work) and not(ancestor::mei:expression) and not(count(ancestor::mei:*) = 0)]" priority="1000" mode="M39">
   ...
   <!--PATTERN tido-beam-When_not_copyof_beam_content-constraint-40-->


	  <!--RULE -->
   <xsl:template match="mei:beam[not(@copyof)]" priority="1000" mode="M40">
   ...
   <!--PATTERN tido-fermata-fermata_start-type_attributes_required-constraint-41-->


	  <!--RULE -->
   <xsl:template match="mei:fermata" priority="1000" mode="M41">
   ...
   <!--PATTERN tido-hairpin-hairpin_place_required_with_single_staff-constraint-42-->


	  <!--RULE -->
   <xsl:template match="mei:hairpin[not(contains(@staff, ' '))]" priority="1000" mode="M42">
   ...
   <!--PATTERN tido-meterSig-meter_att_pair-constraint-43-->


	  <!--RULE -->
   <xsl:template match="mei:meterSig" priority="1000" mode="M43">
   ...
   <!--PATTERN tido-octave-octave_start-_and_end-type_attributes_required-constraint-44-->


	  <!--RULE -->
   <xsl:template match="mei:octave" priority="1000" mode="M44">
   ...
   <!--PATTERN tido-pedal-pedal_style_consistent-constraint-45-->


	  <!--RULE -->
   <xsl:template match="mei:pedal[@form][@dir=('bounce', 'up')]" priority="1000" mode="M45">
   ...
   <!--PATTERN tido-pedal-pedal_start-type_attributes_required-constraint-46-->


	  <!--RULE -->
   <xsl:template match="mei:pedal" priority="1000" mode="M46">
   ...
   <!--PATTERN tido-slur-slur_start-_and_end-type_attributes_required-constraint-47-->


	  <!--RULE -->
   <xsl:template match="mei:slur" priority="1000" mode="M47">
   ...
   <!--PATTERN tido-tie-tie_start-_and_end-type_attributes_required-constraint-48-->


	  <!--RULE -->
   <xsl:template match="mei:tie" priority="1000" mode="M48">
   ...
   <!--PATTERN tido-tie-tie_containing_curve-constraint-49-->


	  <!--RULE -->
   <xsl:template match="mei:tie[mei:curve[@bezier or @bulge or @curvedir or @lform or @lwidth or             @ho or @startho or @endho or @to or @startto or @endto or @vo or @startvo or             @endvo or @x or @y or @x2 or @y2]]" priority="1000" mode="M49">
   ...
   <!--PATTERN tido-mordent-mordent_start-type_attributes_required-constraint-50-->


	  <!--RULE -->
   <xsl:template match="mei:mordent" priority="1000" mode="M50">
   ...
   <!--PATTERN tido-trill-trill_start-type_attributes_required-constraint-51-->


	  <!--RULE -->
   <xsl:template match="mei:trill" priority="1000" mode="M51">
   ...
   <!--PATTERN tido-turn-turn_start-type_attributes_required-constraint-52-->


	  <!--RULE -->
   <xsl:template match="mei:turn" priority="1000" mode="M52">
   ...
   <!--PATTERN tido-fing-stack_exclusion-constraint-53-->


	  <!--RULE -->
   <xsl:template match="mei:fing" priority="1000" mode="M53">
   ...
   <!--PATTERN tido-fingGrp-require_fingeringLike_children-constraint-54-->


	  <!--RULE -->
   <xsl:template match="mei:fingGrp" priority="1000" mode="M54">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="mei:fingGrp[not(ancestor::mei:fingGrp)][@tstamp or @startid]" priority="1001" mode="M55">
	  ...
	  <!--RULE -->
   <xsl:template match="mei:fingGrp[not(ancestor::mei:fingGrp)][not(@tstamp or @startid)]" priority="1000" mode="M55">
   ...
   <!--PATTERN tido-att.spanning.req-require_precisely_one_start_spec-constraint-57-->


	  <!--RULE -->
   <xsl:template match="mei:slur" priority="1000" mode="M56">
   ...
   <!--PATTERN tido-att.spanning.req-require_precisely_one_end_spec-constraint-58-->


	  <!--RULE -->
   <xsl:template match="mei:slur" priority="1000" mode="M57">
